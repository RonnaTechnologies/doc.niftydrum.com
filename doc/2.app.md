...
![Firmware Update (Light Mode)](assets/app-fw-file-light.png){ .light-mode-only .img-shadow-lg }
![Firmware Update (Dark Mode)](assets/app-fw-file.png){ .dark-mode-only .img-shadow-lg }
