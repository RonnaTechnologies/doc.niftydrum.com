...
Some commands require arguments, in which case the syntax is `/command arg1 arg2 arg3`.

## Special Commands

Special commands require no parameters, they either alter the board's behavior, or give specific information about the board.
